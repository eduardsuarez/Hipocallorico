...
function listar() {
  ...
  $.ajax({
    ...
    url: `http://localhost:8090/api/user/birthday/${monthBirthDay}`,
...
function listarUsuariosxCum(items) {
  $("#listado").html("");
  $("#listado").show(500);
  ...
  for (let index = 0; index < items.length; index++) {
      ...
      let typeUser;
      let birthDay = items[index].birthDay;
      birthDay = birthDay.substring(0, birthDay.indexOf("T", birthDay));
