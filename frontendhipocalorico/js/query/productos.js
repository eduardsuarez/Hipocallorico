...
function listar() {
    $.ajax({
        ...
        url: "http://localhost:8090/api/supplements/all",
...
function listarxPrecio() {
    ...
    if(!validaesVacio(precio)) {
        ...
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://localhost:8090/api/supplements/price/${precio}`,
...
function listarxDescripcion() {
    ...
    if(!validaesVacio(descripcion)) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: `http://localhost:8090/api/supplements/description/${descripcion}`,
