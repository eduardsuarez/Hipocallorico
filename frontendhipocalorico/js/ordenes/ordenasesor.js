 ...
 */
function listarOrdxAse() {
  let estadoOrden = $("#estadoOrden").val();

  $.ajax({
    // la URL para la petición (url: "url al recurso o endpoint")
    url: `http://localhost:8090/api/order/salesman/${userId}`,
...
function listarProductosxAse(items) {
...
//cuando carga la página html se ejecuta la función: listarOrdxAse()
$(document).ready(function () {
