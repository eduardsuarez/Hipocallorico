...
function listarxFec() {
  ...
  $.ajax({
    ...
    url: `http://localhost:8090/api/order/date/${dateOrden}/${userId}`,
...
function listarxFecProductos(items) {
...
//cuando carga la página html se ejecuta la función: listarxFec()
$(document).ready(function () {
