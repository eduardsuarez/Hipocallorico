 ...
 */
function listarxZona() {
    $.ajax({
        // la URL para la petición (url: "url al recurso o endpoint")
        url: `http://localhost:8090/api/order/zona/${userZona}`,
        ...
        success: function (respuesta) {
            ...
            listarxZonaProductos(respuesta);
        },
 ...
 */
function listarxZonaProductos(items) {
...
function actualizarEstadoOrden(){
    ...
    $.ajax({
        // la URL para la petición (url: "url al recurso o endpoint")
        url: `http://localhost:8090/api/order/update`,
...
//cuando carga la página html se ejecuta la función: listarxZona()
$(document).ready(function () {
